...
doc.add_paragraph("Cadastro de Contato Externo (CRM) – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
def finalizar_relatorio():
    global driver, doc
    nome_arquivo = f"relatorio_cadastro_contato_externo_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
