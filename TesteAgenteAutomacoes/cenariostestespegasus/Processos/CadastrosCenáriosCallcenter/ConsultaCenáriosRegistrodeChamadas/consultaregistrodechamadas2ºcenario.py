...
def executar_teste():
    ...
    try:
        ...
        safe_action(doc, "Realizando consulta sem preencher os campos, para verificar disparo de mensagens", realizar_consulta())
        ...
        safe_action(doc, "Salvando Contato sem preencher os campos, para verificação de mensagens de alerta", 
        ...
        safe_action(doc, "Fechando aba de Contatos", 
