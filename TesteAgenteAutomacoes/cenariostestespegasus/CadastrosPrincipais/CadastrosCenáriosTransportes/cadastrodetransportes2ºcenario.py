...
doc.add_paragraph("Cadastro de Transporte – Cenário 2: Preenchimento completo e cancelamento.")
...
try:
    ...
    safe_action(doc, "Cancelando cadastro", lambda: (
        wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_200029 a.btGray.btcancel"))).click(),
