...
campo_pesquisa.send_keys("Vínculo Convênio / Conveniado", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div > ul > li > a > span")
cadastrar.click()

time.sleep(2)


open_lov_convenio = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.catWrapper > div > div > div > div > div:nth-child(2) > div:nth-child(1) > div > a"))
)
open_lov_convenio.click()

campo_pesquisa_convenio = WebDriverWait(driver, 10).until(
...
campo_pesquisa_convenio.send_keys('TESTE CONVÊNIO SELENIUM AUTOMATIZADO')

pesquisar_convenio = WebDriverWait(driver, 10).until(
...
pesquisar_convenio.click()

time.sleep(3)
# Espera até que a linha com o texto desejado esteja visível e clicável

element = driver.find_element(By.XPATH, ("//*[@id='DataTables_Table_2']/tbody/tr[1]/td[1]"))
driver.execute_script("arguments[0].click();", element)

open_lov_conveniado = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.catWrapper > div > div > div > div > div:nth-child(2) > div:nth-child(2) > div > a"))
)
...
campo_pesquisa_conveniado = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "body > div.modalHolder > div.modal.overflow > div:nth-child(1) > div.formRow.formLastLine > div.formCol.divPesquisa > div > div > input"))
)
campo_pesquisa_conveniado.send_keys('TESTE CONVENIADO SELENIUM AUTOMATIZADO')

pesquisar_conveniado = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "body > div.modalHolder > div.modal.overflow > div:nth-child(1) > div.formRow.formLastLine > div.formRow > div > a"))
)
pesquisar_conveniado.click()

time.sleep(0.5)
# Espera até que a linha com o texto desejado esteja visível e clicável
conveniado = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.XPATH, "//td[contains(text(), 'TESTE OBSERVAÇÃO SELENIUM AUTOMATIZADO')]"))
)
conveniado.click()
...
open_lov_especialidade = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.catWrapper > div > div > div > div > div:nth-child(3) > div:nth-child(1) > div > div > a"))
)
open_lov_especialidade.click()

time.sleep(3)

campo_pesquisa_especialidade = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "body > div.modalHolder > div.modal.overflow > div:nth-child(1) > div.formRow.formLastLine > div.formCol.divPesquisa > div > div > input"))
)
campo_pesquisa_especialidade.send_keys('CARDIOLOGISTA')

pesquisar_especialidade = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "body > div.modalHolder > div.modal.overflow > div:nth-child(1) > div.formRow.formLastLine > div.formRow > div > a"))
)
pesquisar_especialidade.click()

time.sleep(3)
# Espera até que a linha com o texto desejado esteja visível e clicável

element = driver.find_element(By.XPATH, ("//*[@id='DataTables_Table_4']/tbody/tr/td"))
driver.execute_script("arguments[0].click();", element)


Cancelar = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.btnHolder > a"))
)
Cancelar.click()
...
# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10068 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
