...
doc.add_paragraph("Cadastro de Movimentação Bancária – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_movimentacao_bancaria_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
