...
campo_pesquisa.send_keys("Posto de Combustível", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10098 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()

time.sleep(1)


campo_nome_posto_combustivel = wait.until(
    EC.presence_of_element_located((By.CSS_SELECTOR, "#fmod_10098 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPostoCombustivel > div.catWrapper > div > div > div > div > div > div:nth-child(2) > input"))
)
campo_nome_posto_combustivel.send_keys("TESTE SELENIUM POSTO DE COMBUSTÍVEL AUTOMATIZADO")

campo_descricao_posto_combustivel = wait.until(
    EC.presence_of_element_located((By.CSS_SELECTOR, "#fmod_10098 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPostoCombustivel > div.catWrapper > div > div > div > div > div > div:nth-child(3) > input"))
)
campo_descricao_posto_combustivel.send_keys("TESTE DESCRIÇÃO SELENIUM POSTO DE COMBUSTÍVEL AUTOMATIZADO")
...
Salvar = driver.find_element(By.CSS_SELECTOR, "#fmod_10098 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPostoCombustivel > div.btnHolder > a.btModel.btGray.btsave")
Salvar.click()
time.sleep(7)
...
# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10098 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
time.sleep(1)
