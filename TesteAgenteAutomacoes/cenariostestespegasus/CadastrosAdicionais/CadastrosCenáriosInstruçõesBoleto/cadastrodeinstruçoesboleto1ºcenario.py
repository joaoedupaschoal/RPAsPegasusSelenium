...
doc.add_paragraph("Cadastro de Instruções Boleto – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_instrucoes_boleto_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
