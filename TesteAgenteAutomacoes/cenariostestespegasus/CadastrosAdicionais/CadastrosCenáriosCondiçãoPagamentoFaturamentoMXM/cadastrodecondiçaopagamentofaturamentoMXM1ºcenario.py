...
doc.add_paragraph("Cadastro de Condição de Pagamento Faturamento MXM – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_condicao_pagamento_faturamento_mxm_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Salvando cadastro", lambda: driver.find_element(
        By.CSS_SELECTOR, "#fmod_10071 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroCondicaoPagamentoFaturamentoMXM > div.btnHolder > a.btModel.btGray.btsave"
    ).click())
