...
doc.add_paragraph("Cadastro de Quadras – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_quadras_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
