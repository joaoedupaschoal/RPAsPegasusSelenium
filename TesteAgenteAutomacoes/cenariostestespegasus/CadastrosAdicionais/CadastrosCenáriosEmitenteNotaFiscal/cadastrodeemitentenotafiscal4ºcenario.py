...
doc.add_paragraph("Cadastro de Emitente Nota Fiscal – Cenário 1: Preenchimento dos campos NÃO obrigatórios e salvamento")
...
def finalizar_relatorio():
    ...
    try:
        ...
        nome_arquivo = f"relatorio_emitente_nf_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
