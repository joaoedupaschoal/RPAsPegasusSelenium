...
doc.add_paragraph("Cadastro de Convênio da Ordem de Serviço – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_convenio_os_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
