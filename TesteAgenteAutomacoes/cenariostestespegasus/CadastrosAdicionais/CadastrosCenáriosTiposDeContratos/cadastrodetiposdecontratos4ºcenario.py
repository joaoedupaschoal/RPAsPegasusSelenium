...
doc.add_paragraph("Cadastro de Tipo de Contrato – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_tipo_contrato_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
