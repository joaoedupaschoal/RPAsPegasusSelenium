...
'''Nesse teste, o robô preencherá todos os dados e cancelará o cadastro'''


print('Nesse teste, o robô preencherá todos os dados e cancelará o cadastro')
...
campo_data_registro = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, 'input[grupo="10036"][ref="10118"]'))
)

driver.execute_script("arguments[0].scrollIntoView();", campo_data_registro)

# Garante que o campo está pronto para receber entrada
campo_data_registro.click()
campo_data_registro.clear()
campo_data_registro.send_keys(data_registro)
...
campo_hora_sepultamento = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_23 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div > div:nth-child(1) > div > div:nth-child(42) > input"))
)

# Garante que o campo está visível e interagível antes de preencher
campo_hora_sepultamento.click()
campo_hora_sepultamento.clear()  # Remove qualquer valor existente
campo_hora_sepultamento.send_keys(hora_sepultamento)
...
salvar = WebDriverWait(driver, 10).until(
    EC.presence_of_element_located((By.CSS_SELECTOR, "#fmod_23 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel > span"))
) 
salvar.click()  
...
wait = WebDriverWait(driver, 10)
botao_nao = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "#BtYes")))
botao_nao.click()
botao_nao.click()
botao_nao.click()
