...
doc.add_paragraph("Cadastro de Modo Envio de Cobrança – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_modo_envio_cobranca_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
