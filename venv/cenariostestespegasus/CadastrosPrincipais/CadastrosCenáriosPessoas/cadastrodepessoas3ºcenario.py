...
def preencher_campo_com_retry(driver, wait, seletor, valor, max_tentativas=1):
...
doc.add_paragraph("Cadastro de Pessoas – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_pessoas_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
