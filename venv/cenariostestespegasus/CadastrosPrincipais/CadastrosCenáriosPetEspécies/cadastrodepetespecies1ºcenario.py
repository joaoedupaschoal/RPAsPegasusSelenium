...
doc.add_paragraph("Cadastro de PET - Espécies – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_pet_especies_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Preenchendo o Nome da Espécie do PET", lambda: (
        ...
        .send_keys('TESTE ESPÉCIE DO PET SELENIUM AUTOMATIZADO')
    ))
