...
def main():
    ...
    if not safe_action(doc, "Acessando a Aba 'Cronograma'", acessar_aba_cronograma, driver, wait)[0]:
        finalizar_relatorio()
        return
    registrar_screenshot_unico("formulario_aberto", driver, doc, "Aba 'Cronograma' aberta.")
