...
campo_pesquisa.send_keys("Fonte de Informação", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10069 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()
...
Salvar = driver.find_element(By.CSS_SELECTOR, "#fmod_10069 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroFonteInformacao > div.btnHolder > a.btModel.btGray.btsave")
Salvar.click()
time.sleep(1)

# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10069 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
time.sleep(1)
