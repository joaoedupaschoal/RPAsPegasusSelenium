...
campo_nome = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10019 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div > div > div > div > input"))
)
campo_nome.send_keys('TESTE DESCRIÇÃO TIPO DE VENDA SELENIUM AUTOMATIZADO')
...
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_10019 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)
