...
doc.add_paragraph("Cadastro de Plano de Contas – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_plano_contas_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
