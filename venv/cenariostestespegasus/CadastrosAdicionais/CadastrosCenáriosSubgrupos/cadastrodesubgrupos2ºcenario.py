...
campo_pesquisa.send_keys("Subgrupo", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10025 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()
...
campo_nome = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10025 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div > div > div > div:nth-child(2) > input"))
)
campo_nome.send_keys('TESTE SUBGRUPO SELENIUM AUTOMATIZADO')

Select(driver.find_element(By.CSS_SELECTOR, "#fmod_10025 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div > div > div > div:nth-child(3) > select")).select_by_visible_text("TESTE GRUPO SELENIUM AUTOMATIZADO")
...
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_10025 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)

wait = WebDriverWait(driver, 10)
Sim = wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, "#BtYes"))
)
Sim.click()

# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10025 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
time.sleep(1)
