...
doc.add_paragraph("Cadastro de Subgrupos – Cenário 3: Preenchimento dos campos NÃO obrigaórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_subgrupos_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
