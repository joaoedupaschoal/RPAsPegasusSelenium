...
doc.add_paragraph("Cadastro de Jazigos em Lote – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
try:
    ...
    safe_action_enhanced(driver, doc, "Confirmando salvamento (se necessário)", lambda: (
        time.sleep(2),
        safe_click_enhanced(driver, "#BtYes", timeout=5) if driver.find_elements(By.CSS_SELECTOR, "#BtYes")
        else True,
        encontrar_mensagem_alerta(driver, doc)  # Adicionar esta linha
