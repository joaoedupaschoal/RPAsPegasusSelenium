...
campo_pesquisa.send_keys("Procedimentos", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10085 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()

time.sleep(2)


campo_descriçao = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10085 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroProcedimento > div.catWrapper > div > div > div > div > div > div:nth-child(2) > input"))
)
campo_descriçao.send_keys('TESTE PROCEDIMENTO SELENIUM AUTOMATIZADO')



Select(driver.find_element(By.CSS_SELECTOR, "#fmod_10085 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroProcedimento > div.catWrapper > div > div > div > div > div > div:nth-child(4) > select")).select_by_visible_text("Médico")


campo_valor_procedimento = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10085 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroProcedimento > div.catWrapper > div > div > div > div > div > div:nth-child(5) > input"))
)
campo_valor_procedimento.send_keys(fake.random_int(min=10000, max=1000000))

# Clique no botão "Cancelar"
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_10085 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroProcedimento > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)

# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10085 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
time.sleep(1)
