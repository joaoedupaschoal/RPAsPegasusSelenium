...
campo_pesquisa.send_keys("Tipos de Documento", Keys.ENTER)
...
cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_9 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()
...
campo_nome = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_9 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div > div > div > div:nth-child(2) > input"))
)
campo_nome.send_keys('TESTE DOCUMENTO SELENIUM AUTOMATIZADO')
...
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_9 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)
...
# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_9 > div.wdTop.ui-draggable-handle > div.wdClose > a")
X.click()
time.sleep(1)
