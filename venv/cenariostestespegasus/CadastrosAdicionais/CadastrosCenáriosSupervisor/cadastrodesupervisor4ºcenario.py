...
'''Nesse teste, o robô preencherá todos os Campos Não Obrigatórios e clicará em Salvar'''

print('Nesse teste, o robô preencherá todos os Campos Não Obrigatórios e clicará em Salvar')
