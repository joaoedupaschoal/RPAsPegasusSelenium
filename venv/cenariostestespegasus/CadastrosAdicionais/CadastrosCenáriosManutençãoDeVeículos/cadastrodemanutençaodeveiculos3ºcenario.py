...
Salvar = driver.find_element(By.CSS_SELECTOR, "#fmod_10062 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroManutencaoVeiculo > div.btnHolder > a.btModel.btGray.btsave")
Salvar.click()
time.sleep(1)
