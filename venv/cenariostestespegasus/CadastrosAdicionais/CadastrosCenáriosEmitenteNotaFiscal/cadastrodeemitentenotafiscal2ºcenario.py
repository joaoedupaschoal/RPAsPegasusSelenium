...
doc.add_paragraph("Cadastro de Emitente Nota Fiscal – Cenário 2: Preenchimento completo e cancelamento.")
...
try:
    ...
    campos_parte1 = [
        ...
        ("#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10056.categoriaHolder > div > div > div:nth-child(8) > input", dados_emitente['complemento'], "Complemento"),
    ...
    campos_parte2 = [
        ...
        ("#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10056.categoriaHolder > div > div > div:nth-child(19) > input", dados_emitente['frase_secreta'], "Frase Secreta"),
        ("#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10056.categoriaHolder > div > div > div:nth-child(20) > input", dados_emitente['senha'], "Senha"),
        ("#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10056.categoriaHolder > div > div > div:nth-child(21) > input", dados_emitente['outras_informacoes'], "Outras Informações"),
    ]
    ...
    safe_action(doc, "Acessando aba Dados NFSE", lambda: (
        wait.until(EC.element_to_be_clickable((By.LINK_TEXT, "Dados NFSE"))).click()
    ))

    # Campo: Item da lista de serviços
    item_lista = str(fake.random_int(min=0, max=99999))
    seletor_item = "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div:nth-child(3) > input"
    print(f"Preenchendo campo Item da lista de serviços com '{item_lista}'")
    preencher_campo_com_retry(driver, wait, seletor_item, item_lista)

    # Campo: Descrição
    descricao = "TESTE DESCRIÇÃO SELENIUM AUTOMATIZADO"
    seletor_descricao = "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div:nth-child(4) > input"
    print(f"Preenchendo campo Descrição com '{descricao}'")
    preencher_campo_com_retry(driver, wait, seletor_descricao, descricao)

    # Campo: Código Tributação Municipal
    cod_tributacao = str(fake.random_int(min=10000000000000000000, max=99999999999999999999))
    seletor_tributacao = "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div:nth-child(5) > input"
    print(f"Preenchendo campo Código Tributação Municipal com '{cod_tributacao}'")
    preencher_campo_com_retry(driver, wait, seletor_tributacao, cod_tributacao)

    # Campo: Alíquota
    aliquota = str(fake.random_int(min=0, max=999999))
    seletor_aliquota = "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div:nth-child(6) > input"
    print(f"Preenchendo campo Alíquota com '{aliquota}'")
    preencher_campo_com_retry(driver, wait, seletor_aliquota, aliquota)

    # Campo: Código CNAE
    codigo_cnae = str(fake.random_int(min=1000000, max=9999999))
    seletor_cnae = "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div:nth-child(7) > input"
    print(f"Preenchendo campo Código CNAE com '{codigo_cnae}'")
    preencher_campo_com_retry(driver, wait, seletor_cnae, codigo_cnae)



    safe_action(doc, "Adicionando Dados NFSE", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10046 > div.wdTelas > div.telaCadastro.clearfix > div.catWrapper > div > div.cat_10057.categoriaHolder > div > div > div.btnListHolder > a.btAddGroup"))
        ).click()
    ))

    safe_action(doc, "Cancelando cadastro", lambda: (
        log(doc, "Clicando no botão cancelar..."),
        clicar_elemento_js(driver, wait, "#fmod_10046 div.btnHolder > a.btModel.btGray.btcancel", "Botão Cancelar"),
    ))
    ...
    safe_action(doc, "Verificando resultado do cancelamento", lambda: (
