...
campo_modelo = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10004 > div.wdTelas > div > div.catWrapper > div > div > div > div > div:nth-child(3) > input"))  
)
campo_modelo.send_keys(modelo)

# Localiza e preenche o campo "Ano"
campo_ano = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10004 > div.wdTelas > div > div.catWrapper > div > div > div > div > div:nth-child(4) > input")) 
)
campo_ano.send_keys(ano)


campo_combustivel = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10004 > div.wdTelas > div > div.catWrapper > div > div > div > div > div:nth-child(5) > input"))  
)
campo_combustivel.send_keys(combustivel_escolhido)

Select(driver.find_element(By.CSS_SELECTOR, "#fmod_10004 > div.wdTelas > div > div.catWrapper > div > div > div > div > div:nth-child(7) > select")).select_by_visible_text("BMW")
...
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_10004 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)
