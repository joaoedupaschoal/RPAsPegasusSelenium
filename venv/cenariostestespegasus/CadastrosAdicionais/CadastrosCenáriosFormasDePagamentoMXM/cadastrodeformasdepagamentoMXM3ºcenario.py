...
doc.add_paragraph("Cadastro de Formas de Pagamento MXM – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_formas_de_pagamento_mxm_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
