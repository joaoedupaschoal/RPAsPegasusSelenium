...
doc.add_paragraph("Cadastro de Grupos de Óbito – Cenário 3: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_grupo_obito_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
