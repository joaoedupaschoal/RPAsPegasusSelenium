...
doc.add_paragraph("Cadastro de Escala Motorista – Cenário 3: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_escala_motorista_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
