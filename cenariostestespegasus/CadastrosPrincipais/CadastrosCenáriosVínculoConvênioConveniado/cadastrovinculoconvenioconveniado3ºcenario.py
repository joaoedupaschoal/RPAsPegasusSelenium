...
Salvar_vinculo = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.catWrapper > div > div > div > div > div:nth-child(3) > div:nth-child(2) > a"))
)
Salvar_vinculo.click()

pesquisar_vinculo = WebDriverWait(driver, 10).until(
    EC.element_to_be_clickable((By.CSS_SELECTOR, "#fmod_10068 > div.wdTelas > div.telaCadastro.clearfix.telaVinculoConvenioConveniado > div.catWrapper > div > div > div > div > div:nth-child(3) > div:nth-child(3) > a"))
)
