...
doc.add_paragraph("Cadastro de Tipo de Entrega – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_tipo_entrega_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Salvando cadastro", lambda: driver.find_element(
        By.CSS_SELECTOR, "#fmod_10078 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroTipoEntrega > div.btnHolder > a.btModel.btGray.btsave"
    ).click())
