...
doc.add_paragraph("Cadastro de PET - Espécies – Cenário 2: Preenchimento completo e cancelamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_pet_especies_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
