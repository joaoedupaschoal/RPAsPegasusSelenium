...
doc.add_paragraph("Cadastro de Conta Bancária – Cenário 2: Preenchimento completo e cancelamento.")
...
try:
    ...
    safe_action(doc, "Cancelando Cadastro", lambda: 
        wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, 
            "#fmod_10 > div.wdTelas > div.telaCadastro.clearfix > div.btnHolder > a.btModel.btGray.btcancel"
        ))).click()
    )
