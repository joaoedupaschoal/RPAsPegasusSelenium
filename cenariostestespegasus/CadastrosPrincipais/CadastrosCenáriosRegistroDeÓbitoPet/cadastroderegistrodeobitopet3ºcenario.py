...
doc.add_paragraph("Cadastro de Registro de Óbito Pet – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_registro_obito_pet_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
