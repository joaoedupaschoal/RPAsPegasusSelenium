...
def main():
    ...
    doc.add_paragraph("Neste teste, o robô preencherá apenas os dados NÃO obrigatórios e salvará o cadastro de uma nova Conciliação Bancária.")
    ...
    def finalizar_relatorio():
        doc_name = f"relatorio_conciliacao_bancaria_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
        doc.save(doc_name)
