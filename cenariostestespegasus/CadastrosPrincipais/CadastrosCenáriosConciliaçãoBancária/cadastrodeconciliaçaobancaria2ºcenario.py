...
def main():
    ...
    doc.add_paragraph("Neste teste, o robô preencherá todos os dados obrigatórios e cancelará o cadastro de uma nova Conciliação Bancária.")
    ...
    def finalizar_relatorio():
        doc_name = f"relatorio_conciliacao_bancaria_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
        doc.save(doc_name)
