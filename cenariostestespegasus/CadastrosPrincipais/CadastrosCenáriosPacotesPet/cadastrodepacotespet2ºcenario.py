...
doc.add_paragraph("Cadastro de Pacotes PET – Cenário 2: Preenchimento completo e cancelamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_pacotes_pet_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Preenchendo o Nome do Pacote PET", lambda: (
        time.sleep(2),
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_dadosGerais > div > div > div:nth-child(1) > input"))
        ).send_keys('TESTE PACOTE PET SELENIUM AUTOMATIZADO ')
    ))
    
    

    safe_action(doc, "Preenchendo a Quantidade Máxima de Pets", lambda: (
        time.sleep(2),
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_dadosGerais > div > div > div:nth-child(3) > input"))
        ).send_keys(fake.random_int(min=1, max=20))
    ))


    safe_action(doc, "Preenchendo a Vigência em Dias", lambda: (
        time.sleep(2),
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_dadosGerais > div > div > div:nth-child(4) > input"))
    ...
    safe_action(doc, "Preenchendo a Taxa Adesão", lambda: (
        time.sleep(2),
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaAdesao > div > div > div:nth-child(1) > input"))
        ).send_keys(fake.random_int(min=10000, max=300000))
    ))
    ...
    safe_action(doc, "Preenchendo a Taxa Mensal", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(1) > input"))
    ...
    safe_action(doc, "Preenchendo a Taxa Bimestral", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(2) > input"))
    ...
    safe_action(doc, "Preenchendo a Taxa Trimestral", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(3) > input"))
        ).send_keys(fake.random_int(min=1000, max=50000))
    ))

    safe_action(doc, "Preenchendo a Taxa Quadrimestral", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(4) > input"))
        ).send_keys(fake.random_int(min=1000, max=50000))
    ))


    safe_action(doc, "Preenchendo a Taxa Semestral", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(5) > input"))
        ).send_keys(fake.random_int(min=1000, max=50000))
    ))

    safe_action(doc, "Preenchendo a Taxa Anual", lambda: (
        wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.catWrapper > div > div.cat_parametros.categoriaHolder > div.groupHolder.clearfix.grupo_grupoTaxaManutencao > div > div > div:nth-child(6) > input"))
        ).send_keys(fake.random_int(min=1000, max=50000))
    ))
    ...
    safe_action(doc, "Cancelando cadastro", lambda: driver.find_element(
        By.CSS_SELECTOR, "#fmod_10080 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroPacotePet > div.btnHolder > a.btModel.btGray.btcancel"
    ).click())
