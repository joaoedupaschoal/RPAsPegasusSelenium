...
doc.add_paragraph("Cadastro de Cor – Cenário 2: Preenchimento completo e cancelamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_cor_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Preechendo o Nome da Cor", lambda: (
        ...
        ).send_keys('TESTE COR SELENIUM AUTOMATIZADO 2')
    ))
