...
doc.add_paragraph("Cadastro de Cor – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_cor_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Preechendo o Nome da Cor", lambda: (
        ...
        ).send_keys('TESTE COR SELENIUM AUTOMATIZADO 25')
    ))
