...
doc.add_paragraph("Cadastro de Emitente Nota Fiscal – Cenário 1: Preenchimento completo e salvamento")
...
def finalizar_relatorio():
    ...
    try:
        ...
        nome_arquivo = f"relatorio_emitente_nf_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
