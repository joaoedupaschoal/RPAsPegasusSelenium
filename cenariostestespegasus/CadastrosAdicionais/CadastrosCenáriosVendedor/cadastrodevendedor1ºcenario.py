...
doc.add_paragraph("Cadastro de Vendedores – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_vendedores_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
