...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_exames_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Salvando cadastro", lambda: driver.find_element(
        By.CSS_SELECTOR, "#fmod_10064 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroEspecialidade > div.btnHolder > a.btModel.btGray.btsave"
    ).click())
