...
campo_pesquisa.send_keys("Exames", Keys.ENTER)



time.sleep(3)

cadastrar = driver.find_element(By.CSS_SELECTOR, "#fmod_10087 > div.wdTelas > div.telaInicial.clearfix.overflow.overflowY > ul > li:nth-child(1) > a > span")
cadastrar.click()
...
campo_descriçao = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10087 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroExame > div.catWrapper > div > div > div > div > div > div:nth-child(2) > input"))
)
campo_descriçao.send_keys('TESTE EXAME SELENIUM AUTOMATIZADO')


campo_valor_exame = WebDriverWait(driver, 10).until(
    EC.visibility_of_element_located((By.CSS_SELECTOR, "#fmod_10087 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroExame > div.catWrapper > div > div > div > div > div > div:nth-child(3) > input"))
)
campo_valor_exame.send_keys(fake.random_int(min=10000, max=1000000))
...
Cancelar = driver.find_element(By.CSS_SELECTOR, "#fmod_10087 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroExame > div.btnHolder > a.btModel.btGray.btcancel")
Cancelar.click()
time.sleep(1)

# Fechar modal
X = driver.find_element(By.CSS_SELECTOR, "#fmod_10087 > div.wdTop.ui-draggable-handle > div.wdClose")
X.click()
time.sleep(1)
