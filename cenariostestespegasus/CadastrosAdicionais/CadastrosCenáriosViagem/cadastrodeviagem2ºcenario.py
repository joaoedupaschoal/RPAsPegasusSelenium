...
doc.add_paragraph("Cadastro de Viagens – Cenário 2: Preenchimento completo e cancelamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_viagens_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
...
try:
    ...
    safe_action(doc, "Cancelando cadastro", lambda: driver.find_element(
        By.CSS_SELECTOR, "#fmod_10089 > div.wdTelas > div.telaCadastro.clearfix.telaCadastroViagem > div.btnHolder > a.btModel.btGray.btcancel"
    ).click())
