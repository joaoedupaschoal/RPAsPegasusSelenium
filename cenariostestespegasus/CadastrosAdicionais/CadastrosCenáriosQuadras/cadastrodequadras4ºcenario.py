...
doc.add_paragraph("Cadastro de Quadras – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_quadras_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
...
try:
    ...
    safe_action_enhanced(driver, doc, "Salvando cadastro", 
        lambda: safe_click_enhanced(driver, "#fmod_6 > div.wdTelas > div.telaCadastro.clearfix.TelaCadastroQuadra > div.btnHolder > a.btModel.btGray.btsave"))
