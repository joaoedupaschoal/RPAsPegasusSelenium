...
doc.add_paragraph("Cadastro de Condição de Pagamento Faturamento MXM – Cenário 3: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_condicao_pagamento_faturamento_mxm_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
