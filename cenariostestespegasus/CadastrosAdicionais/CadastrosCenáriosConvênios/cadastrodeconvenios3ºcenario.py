...
doc.add_paragraph("Cadastro de Convênios – Cenário 3: Preenchimento dos campos obrigatórios e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_convenio_cenario_3_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
