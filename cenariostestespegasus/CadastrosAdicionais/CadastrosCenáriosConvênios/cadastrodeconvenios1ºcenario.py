...
doc.add_paragraph("Cadastro de Convênios – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_convenio_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
