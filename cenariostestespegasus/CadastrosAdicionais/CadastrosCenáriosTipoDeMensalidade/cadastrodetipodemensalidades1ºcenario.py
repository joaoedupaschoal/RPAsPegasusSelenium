...
doc.add_paragraph("Cadastro de Tipo de Mensalidade – Cenário 1: Preenchimento completo e salvamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_tipo_mensalidade_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
