...
doc.add_paragraph("Cadastro de Jazigos – Cenário 2: Preenchimento completo e cancelamento.")
...
def finalizar_relatorio():
    nome_arquivo = f"relatorio_jazigos_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
