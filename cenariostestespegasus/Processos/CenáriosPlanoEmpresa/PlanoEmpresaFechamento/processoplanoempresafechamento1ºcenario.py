...
class PlanoEmpresaTest:
    ...
    def setup_document(self):
        ...
        self.doc = Document()
        self.doc.add_heading("RELATÓRIO DO TESTE - FECHAMENTO PLANO EMPRESA", 0)
    ...
    def fill_fechamento_data(self) -> bool:
        ...
        def fill_data_action():
            ...
            success = self.datepicker_handler.fill_datepicker_by_index(0, "17/08/2025")
            if not success:
    ...
    def select_tipo_mensalidade(self) -> bool:
        ...
        def select_action():
            success = self.modal_handler.open_modal_and_select(
                '#gsPlanoEmpresa > div.wdTelas > div:nth-child(4) > div.contentHolder.clearfix.overflow.overflowY > div:nth-child(2) > div:nth-child(5) > div > a',
    ...
    def execute_fechamento(self) -> bool:
        ...
        def fechamento_action():
            self.element_handler.robust_click((
                By.CSS_SELECTOR,
                '#gsPlanoEmpresa > div.wdTelas > div:nth-child(4) > div.btnHolder > a:nth-child(2)'
            ))
    ...
    def finalize_report(self):
        ...
        filename = f"relatorio_fechamento_plano_empresa_{timestamp}.docx"
