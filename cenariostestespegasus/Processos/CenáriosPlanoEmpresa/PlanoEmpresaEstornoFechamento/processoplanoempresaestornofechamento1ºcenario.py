...
class PlanoEmpresaTest:
    ...
    def setup_document(self):
        ...
        self.doc.add_paragraph(
            "Processo: Estorno Fechamento Plano Empresa – Cenário 1: "
            "Nesse teste, o usuário irá realizar o Estorno de um fechamento de um Plano Empresa."
        )
    ...
    def run_test(self) -> bool:
        ...
        try:
            ...
            steps = [
                ...
                ("Selecionar Mês/Ano", self.select_mes_ano),  
                ("Busca do Plano Empresa", self.search_plano_empresa),
                ("Estorno do fechamento", self.execute_estorno_fechamento),
