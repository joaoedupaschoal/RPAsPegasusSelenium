...
doc.add_paragraph("Cadastro de Reagrupamento de Rateios - Rateio – Cenário 1: Nesse teste, será realizado um Reagrupamento de Rateio.")
...
def executar_teste():
    ...
    try:
        ...
        safe_action(doc, "Informando a quantidade de Contratos para realização do Reagrupamento", lambda:
            preencher_campo_xpath_com_retry(
