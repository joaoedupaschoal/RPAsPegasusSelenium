...
doc.add_paragraph("Agenda CRM – Cenário 2: Consulta teste de Eventos na Agenda CRM, mas sem preencher os dados da consulta, com a finalidade de verificar se o sistema dipara mensagens de alerta e erros.")
...
def finalizar_relatorio():
    global driver, doc
    nome_arquivo = f"relatorio_agenda_crm_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
