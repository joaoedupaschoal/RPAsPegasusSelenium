...
doc.add_paragraph("Funil de Vendas Pipeline (CRM) – Cenário 2: Consulta teste no Funil de Vendas Pipeline: Não preencherá nenhum campo para verificar se o sistema está disparando a mensagem de alerta corretamente.")
...
def finalizar_relatorio():
    ...
    nome_arquivo = f"relatorio_funil_de_vendas_pipeline_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
