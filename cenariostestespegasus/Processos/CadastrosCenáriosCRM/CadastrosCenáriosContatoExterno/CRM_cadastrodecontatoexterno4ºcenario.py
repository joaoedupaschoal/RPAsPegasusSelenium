...
doc.add_paragraph("Cadastro de Contato Externo (CRM) – Cenário 4: Não preencherá a aba Cliente/Empresa, para verificar se o sistema está disparando a mensagem de alerta corretamente.")
...
def executar_teste():
    ...
    try:
        ...
        safe_action(doc, "Tentando avançar para a aba seguinte (para o disparo a mensagem)", lambda:
            clicar_elemento_robusto(driver, wait, '#gsCrm > div.wdTelas > div.wdWizard.clearfix.telaConsulta > div.btnHolder > a:nth-child(3)')
        )
