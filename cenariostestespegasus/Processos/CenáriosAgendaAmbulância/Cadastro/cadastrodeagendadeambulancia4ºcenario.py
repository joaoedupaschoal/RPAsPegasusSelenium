...
doc.add_paragraph("Cadastro de Agenda de Ambulância – Cenário 4: Preenchimento dos campos NÃO obrigatórios e salvamento.")
...
def finalizar_relatorio():
    ...
    nome_arquivo = f"relatorio_agenda_ambulancia_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
...
def executar_teste():
    ...
    try:
        ...
        safe_action(doc, "Fechando modal após a conferência da mensagem de alerta", clicar_elemento_robusto(
