...
doc.add_paragraph("Cadastro de Contrato Pet – Cenário 4: Não selecionará o Pacote do Contrato Pet, para verificar se o sistema está disparando a mensagem de alerta corretamente.")
...
def finalizar_relatorio():
    global driver, doc
    nome_arquivo = f"relatorio_cadastro_contrato_pet_cenario_4_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
