...
doc.add_paragraph("Cadastro de Cotação - Gestor de Compras – Cenário 2: Preenchimento completo e cancelamento")
...
def finalizar_relatorio():
    global driver, doc
    nome_arquivo = f"relatorio_cadastro_de_cotacao_cenario_2_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
