...
doc.add_paragraph("Cadastro de Cotação - Gestor de Compras – Cenário 1: Preenchimento completo e salvamento")
...
def finalizar_relatorio():
    global driver, doc
    nome_arquivo = f"relatorio_cadastro_de_cotacao_cenario_1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
    try:
